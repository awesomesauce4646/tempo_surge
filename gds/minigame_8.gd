...
@onready var firstNote: Button = $C
@onready var secondNote: Button = $C2
@onready var thirdNote: Button = $D
@onready var fourthNote: Button = $A
@onready var fifthNote: Button = $A2
@onready var sixthNote: Button = $G
